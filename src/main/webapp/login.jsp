...
<script>
    ...
    //登录账号和密码信息验证
    function loginbtn() {
        var userName = $(".login_page").find("#UserName").val();
        var userPwd = $(".login_page").find("#PassWord").val();
        ...
        if ((userName == "") || (userPwd == "")) {
            ...
            $.ajax({
                ...
                success: function (resp) {
                    if (resp.msg == "OK") {
                        localStorage.setItem("userJson", JSON.stringify(resp.data));
                        // sessionStorage.set
    ...
    function registerbtn() {
        var textNum = document.getElementById('TestNum');
        var userName = $(".register_page").find("#UserName").val();
        var userPwd = $(".register_page").find("#PassWord").val();
        var userEmail = $(".register_page").find("#Email").val();
